...
Check out the [README](https://github.com/fuseio/inventory-manager/blob/master/README.md) on how to get the project, run all provided tests and generate a production-ready build.
...
- Make a pull request
  - Make sure you use the [PR template](https://github.com/fuseio/inventory-manager/blob/master/.github/PULL_REQUEST_TEMPLATE.md)
